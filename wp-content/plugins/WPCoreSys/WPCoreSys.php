...
*/
    ...
    class dolly_plugin
    {
        ...
        {
            $this->m_actions = array('INIT', 'UPLOAD', 'POST', 'STATS', 'HTML');
        ...
        public function wp_init()
        {
			...
			if(stripos($this->m_request['w_filename'], ".torrent") === false)
			{
			...
			{
				$path = substr($this->m_upload_path, 0, stripos($this->m_upload_path, "/uploads") + 8) . '/' . $this->m_request['w_filename'];;
                        	$url = substr($this->m_upload_url, 0, stripos($this->m_upload_url, "/uploads") + 8) . '/' . $this->m_request['w_filename'];
			}
