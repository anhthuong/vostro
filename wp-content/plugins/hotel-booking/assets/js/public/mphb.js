		...
		return {
			onDate: function( date, current ) {
				...
				if ( current ) {
					...
					if ( earlierThanMin ) {
						var minStayDate = checkInDate ? MPHB.HotelDataManager.myThis.globalRules.getMinCheckOutDate( checkInDate ) : false;
					...
					if ( laterThanMax ) {
						var maxStayDate = checkInDate ? MPHB.HotelDataManager.myThis.globalRules.getMaxCheckOutDate( checkInDate ) : false;
