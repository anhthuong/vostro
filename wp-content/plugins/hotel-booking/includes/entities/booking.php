...
class Booking {
	...
	public function getPriceBreakdown(){
		...
		foreach ( $this->reservedRooms as $reservedRoom ) {
			$roomsBreakdown[] = $reservedRoom->getPriceBreakdown( $this->checkInDate, $this->checkOutDate, $this->language );
		}
	...
	public function calcPrice(){
		...
		foreach ( $this->reservedRooms as $reservedRoom ) {
			$reservedRoomPrice = $reservedRoom->calcPrice( $this->checkInDate, $this->checkOutDate );
	 ...
	 */
	public function addReservedRoom( ReservedRoom $reservedRoom ){
