...
//			Configuration::sslVersion( 6 );
	...
	public function registerOptionsFields( &$subTab ){
		...
		if ( !empty( $this->apiIssues ) ) {
			...
			$message = sprintf( $message, __( 'Braintree', 'motopress-hotel-booking' ), MPHB()->getSettingsMenuPage()->getUrl( array( 'tab' => 'payments' ) ) );
