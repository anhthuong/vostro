...
class Statuses extends AbstractCPT\Statuses {
	...
	public function canStatusCompleted( $status ){
	...
	public function canStatusRefunded( $status ){
		$allowedStatuses = array(
			self::STATUS_ON_HOLD,
			self::STATUS_PENDING,
	...
	public function canStatusFailed( $status ){
		$allowedStatuses = array(
			self::STATUS_ON_HOLD,
			self::STATUS_PENDING
		);
	...
	public function canStatusOnHolded( $status ){
		$allowedStatuses = array(
			self::STATUS_PENDING
		);
		return in_array( $status, $allowedStatuses );
