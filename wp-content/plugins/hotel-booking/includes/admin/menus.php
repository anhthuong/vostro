...
//		$this->registerSubMenu( 10, $this->mainMenuSlug, $bookingMenuTitle, $bookingMenuTitle, 'edit_posts', $bookingMenuSlug );
		...
		$this->registerSubMenu( 20, $this->mainMenuSlug, $paymentPageTitle, $paymentMenuTitle, 'edit_posts', $paymentMenuSlug );
		...
		$this->registerSubMenu( 60, $this->mainMenuSlug, $couponPageTitle, $couponMenuTitle, 'edit_posts', $couponMenuSlug );
	}
