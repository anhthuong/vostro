...
abstract class InputField {
	...
	public function getInnerLabelTag(){
		return !empty( $this->innerLabel ) ? '&nbsp;<label for="mphb-' . $this->name . '">' . $this->innerLabel . '</label>' : '';
	}

	public function getLabelTag(){
		return !empty( $this->label ) ? '<label for="mphb-' . $this->name . '">' . $this->label . '</label>' : '';
	}
	...
	public function render(){
		...
		echo '<div class="mphb-ctrl-wrapper ' . $this->getCtrlClasses() . '" ' . $this->getCtrlTypeAttr() . '>';
