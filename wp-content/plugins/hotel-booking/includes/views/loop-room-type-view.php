...
class LoopRoomTypeView extends RoomTypeView {
	...
	public static function _renderFacilitiesTitle(){
		echo '<span class="mphb-attribute-title mphb-facilities-title">' . __( 'Facilites:', 'motopress-hotel-booking' ) . '</span>';
	}
	...
	public static function _renderInfoWrapperOpen(){
		echo '<div class="mphb-room-type-info-wrapper">';
	}

	public static function _renderInfoWrapperClose(){
		echo '</div>';
	}
