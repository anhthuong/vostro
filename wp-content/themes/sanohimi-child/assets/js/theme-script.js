(function ($) {
		...
		CherryJsCore.theme_script = {
				...
				smart_slider_init: function (self) {
						$('.sanohimi-smartslider').each(function () {
								var slider = $(this),
				...
				swiper_carousel_init: function (self) {
						...
						jQuery('.sanohimi-carousel').each(function () {
								var swiper = null,
				...
				subscribe_init: function (self) {
						...
						CherryJsCore.variable.$document.on('click', '.subscribe-block__submit', function (event) {
								...
								$.ajax({
										url: sanohimi.ajaxurl,
										type: 'post',
										dataType: 'json',
										data: {
												action: 'sanohimi_subscribe',
												mail: mail,
												nonce: nonce
										},
										error: function () {
				...
				main_menu: function (self, $mainNavigation) {
						...
						if (hasprop.call(window, 'sanohimi') &&
								hasprop.call(window.sanohimi, 'more_button_options') &&
								hasprop.call(window.sanohimi.more_button_options, 'more_button_type')) {
								switch (window.sanohimi.more_button_options.more_button_type) {
										case 'image':
												imgurl = window.sanohimi.more_button_options.more_button_image_url;
												if (window.sanohimi.more_button_options.retina_more_button_image_url) {
														srcset = ' srcset="' + window.sanohimi.more_button_options.retina_more_button_image_url + ' 2x"';
												}
												moreMenuContent = '<img src="' + imgurl + '"' + srcset + ' alt="' + moreMenuContent + '">';
												hasimg = true;
												break;
										case 'icon':
												moreMenuContent = '<i class="fa ' + window.sanohimi.more_button_options.more_button_icon + '"></i>';
												hasicon = true;
												break;
										case 'text':
										default:
												moreMenuContent = window.sanohimi.more_button_options.more_button_text || moreMenuContent;
												hasimg = false;
												hasicon = false;
												break;
								}
				...
				to_top_init: function (self) {
						if ($.isFunction(jQuery.fn.UItoTop)) {
								$().UItoTop({
										text: sanohimi.labels.totop_button,
										scrollSpeed: 600
								});
						}
				},
