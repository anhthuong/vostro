...
<div id="page" class="site">
	...
	<header id="masthead" <?php sanohimi_header_class(); ?> role="banner">
		<?php sanohimi_ads_header(); ?>
		<?php //get_template_part( 'template-parts/header/top-panel' ); ?>
		<div <?php sanohimi_header_container_class(); ?>>
			<div <?php echo sanohimi_get_container_classes( array( 'header-container_wrap container' ) ); ?>>
				<?php get_template_part( 'template-parts/header/layout', get_theme_mod( 'header_layout_type' ) ); ?>
			</div>
		</div><!-- .header-container -->
		<?php sanohimi_site_breadcrumbs(); ?>
	</header><!-- #masthead -->
