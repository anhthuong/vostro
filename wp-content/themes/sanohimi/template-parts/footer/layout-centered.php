	...
	<div <?php echo sanohimi_get_container_classes( array( 'site-info' ), 'footer' ); ?>>
		<div class="container">
                    <div class=" row tm_pb_row tm_pb_row_1">
                        ...
                        <div class="tm_pb_column tm_pb_column_1_2  tm_pb_column_1 col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-6 footer-wrap-right">
                            <div class="footer-address-right">
                                <p>Address:&nbsp;No. 12 Bao Khanh lane, Hoan Kiem dist, Ha Noi, Viet Nam</p>
                                <p>Phone:&nbsp;+84 243 932 0666</p>
                                <p>Local Times:&nbsp;12:22:22 pm</p>
                                <p>Email :&nbsp;Info@DalVostroHotel.com</p>
                            </div>
                        </div>
                    </div>
		</div>
