...
if ( ! class_exists( 'Sanohimi_Custom_Posts_Widget' ) ) {

	class Sanohimi_Custom_Posts_Widget extends Cherry_Abstract_Widget {
		...
		public function __construct() {
			$this->widget_name			= esc_html__( 'Custom Posts', 'sanohimi' );
			$this->widget_description 	= esc_html__( 'Display custom posts your site.', 'sanohimi' );
			$this->widget_id			= apply_filters( 'sanohimi_custom_posts_widget_ID', 'widget-custom-posts' );
			$this->widget_cssclass		= apply_filters( 'sanohimi_custom_posts_widget_cssclass', 'widget-custom-posts custom-posts' );
			$this->utility				= sanohimi_utility()->utility;
			$this->settings 			= array(
				'title' => array(
					'type'				=> 'text',
					'value'				=> esc_html__( 'Custom Posts', 'sanohimi' ),
					'label'				=> esc_html__( 'Title', 'sanohimi' ),
				),
				'terms_type' => array(
					'type'				=> 'radio',
					'value'				=> 'category_name',
					'options'			=> array(
						'category_name' => array(
							'label'		=> esc_html__( 'Category', 'sanohimi' ),
							'slave'		=> 'terms_type_post_category',
						),
						'tag'			=> array(
							'label'		=> esc_html__( 'Tag', 'sanohimi' ),
							'slave'		=> 'terms_type_post_tag',
						),
						'post_format'	=> array(
							'label'		=> esc_html__( 'Post Format', 'sanohimi' ),
							'slave'		=> 'terms_type_post_format',
						),
					),
					'label'				=> esc_html__( 'Choose taxonomy type', 'sanohimi' ),
				),
				'category_name' => array(
					'type'				=> 'select',
					'size'				=> 1,
					...
					'options'			=> false,
					'label'				=> esc_html__( 'Select category', 'sanohimi' ),
					'multiple'			=> true,
					'placeholder'		=> esc_html__( 'Select category', 'sanohimi' ),
				...
				'tag' => array(
					...
					'options'			=> false,
					'label'				=> esc_html__( 'Select tags', 'sanohimi' ),
					'multiple'			=> true,
					'placeholder'		=> esc_html__( 'Select tags', 'sanohimi' ),
				...
				'post_format' => array(
					...
					'options'			=> false,
					'label'				=> esc_html__( 'Select post format', 'sanohimi' ),
					'multiple'			=> true,
					'placeholder'		=> esc_html__( 'Select post format', 'sanohimi' ),
				...
				'posts_per_page' => array(
					...
					'max_value'			=> 50,
					'min_value'			=> 0,
					'label'				=> esc_html__( 'Posts count ( Set 0 to show all. )', 'sanohimi' ),
				),
				'post_offset' => array(
					'type'				=> 'stepper',
					'value'				=> '0',
					...
					'min_value'			=> '0',
					'step_value'		=> '1',
					'label'				=> esc_html__( 'Offset post', 'sanohimi' ),
				),
				'title_length' => array(
					'type'				=> 'stepper',
					'value'				=> '10',
					...
					'min_value'			=> '0',
					'step_value'		=> '1',
					'label'				=> esc_html__( 'Title words length ( Set 0 to hide title. )', 'sanohimi' ),
				),
				'excerpt_length' => array(
					...
					'min_value'			=> '0',
					'step_value'		=> '1',
					'label'				=> esc_html__( 'Excerpt words length ( Set 0 to hide excerpt. )', 'sanohimi' ),
				),
				'meta_data' => array(
					'type'				=> 'checkbox',
					'value'				=> array(
					...
					'options'				=> array(
						'date'				=> esc_html__( 'Date', 'sanohimi' ),
						'author'			=> esc_html__( 'Author', 'sanohimi' ),
						'comment_count'		=> esc_html__( 'Comment count', 'sanohimi' ),
						'category'			=> esc_html__( 'Category', 'sanohimi' ),
						'post_tag'			=> esc_html__( 'Tag', 'sanohimi' ),
						'more_button'		=> esc_html__( 'More Button', 'sanohimi' ),
					),
					'label'				=> esc_html__( 'Display post meta data', 'sanohimi' ),
				),
				'button_text' => array(
					'type'				=> 'text',
					'value'				=> 'Read More',
					'label'				=> esc_html__( 'Post read more button label', 'sanohimi' ),
				),
			);
				...
				echo '<div class="custom-posts__holder row" >';
					...
					foreach ( $posts as $post ) {
						...
						$image = $this->utility->media->get_image( array(
							'size'			=> 'sanohimi-thumb-140-117',
							'mobile_size'	=> 'sanohimi-thumb-140-117',
						...
						$count = $this->utility->meta_data->get_comment_count( array(
							...
							'sufix'			=> _n_noop( '%s comment', '%s comments', 'sanohimi' ),
						) );
	...
	add_action( 'widgets_init', 'sanohimi_register_custom_posts_widget' );
	function sanohimi_register_custom_posts_widget() {
		register_widget( 'Sanohimi_Custom_Posts_Widget' );
	}
}
