...
if ( ! class_exists( 'Sanohimi_Contact_Information_Widget' ) ) {

	class Sanohimi_Contact_Information_Widget extends Cherry_Abstract_Widget {
		...
		public function __construct() {
			...
			$this->widget_description = esc_html__( 'Display an contact-information.', 'sanohimi' );
			$this->widget_id          = 'sanohimi_contact_information_widget';
			$this->widget_name        = esc_html__( 'Contact Information', 'sanohimi' );
			...
			$this->settings = array(
				...
				'contact_information'  => array(
					'type'         => 'repeater',
					'add_label'    => esc_html__( 'Add Contact Information', 'sanohimi' ),
					'title_field'  => 'value',
					'hidden_input' => true,
					'fields'       => array(
						'icon' => array(
							...
							'id'          => 'icon',
							'name'        => 'icon',
							'label'       => esc_html__( 'Choose icon', 'sanohimi' ),
							'icon_data'   => array(
								'icon_set'    => 'cherryWidgetFontAwesome',
								'icon_css'    => SANOHIMI_THEME_CSS . '/font-awesome.min.css',
								'icon_base'   => 'fa',
								'icon_prefix' => 'fa-',
						...
						'value' => array(
							...
							'id'          => 'value',
							'name'        => 'value',
							'placeholder' => esc_html__( 'Value', 'sanohimi' ),
							'label'       => esc_html__( 'Value', 'sanohimi' ),
						),
					),
				),
			);
...
add_action( 'widgets_init', 'sanohimi_register_contact_information_widget' );
function sanohimi_register_contact_information_widget() {
	register_widget( 'Sanohimi_Contact_Information_Widget' );
}
