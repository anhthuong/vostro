 ...
 * @return void
 */
function sanohimi_main_menu() { ?>
	<nav id="site-navigation" class="main-navigation" role="navigation">
		<button class="menu-toggle" aria-controls="main-menu" aria-expanded="false">
			<i class="menu-toggle__icon"></i>
		</button>
		<?php
			$args = apply_filters( 'sanohimi_main_menu_args', array(
				'theme_location'   => 'main',
				'container'        => '',
				'menu_id'          => 'main-menu',
				'fallback_cb'      => 'sanohimi_set_nav_menu',
				'fallback_message' => esc_html__( 'Set main menu', 'sanohimi' ),
			) );
 ...
 * @return void
 */
function sanohimi_footer_menu() {
	if ( ! get_theme_mod( 'footer_menu_visibility', sanohimi_theme()->customizer->get_default( 'footer_menu_visibility' ) ) ) {
		return;
	}
	?>
	...
	<?php
		$args = apply_filters( 'sanohimi_footer_menu_args', array(
			...
			'fallback_message' => esc_html__( 'Set footer menu', 'sanohimi' ),
		) );
 ...
 * @return string
 */
function sanohimi_get_social_list( $context, $type = 'icon' ) {
	static $instance = 0;
	$instance++;
	...
	$args = apply_filters( 'sanohimi_social_list_args', array(
		...
		'echo'             => false,
		'fallback_cb'      => 'sanohimi_set_nav_menu',
		'fallback_message' => esc_html__( 'Set social menu', 'sanohimi' ),
	), $context, $type );
 ...
 * @return void
 */
function sanohimi_set_nav_menu( $args ) {
