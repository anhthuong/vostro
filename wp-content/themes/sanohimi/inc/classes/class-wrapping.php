 ...
 */
add_filter( 'template_include', array( 'Sanohimi_Wrapping', 'wrap' ), 99 );
add_filter( 'sanohimi_wrap_base', 'sanohimi_wrap_base_cpts' );
 ...
 */
function sanohimi_template_path() {
	return Sanohimi_Wrapping::$main_template;
}
 ...
 */
function sanohimi_template_base() {
	return Sanohimi_Wrapping::$base;
}

if ( ! class_exists( 'Sanohimi_Wrapping' ) ) {
	...
	class Sanohimi_Wrapping {
		...
		/**
		 * Initialize new instance of Sanohimi_Wrapping class by setting a variable for the $slug (which defaults to base)
		...
		public function __toString() {
			$this->templates = apply_filters( 'sanohimi_wrap_' . $this->slug, $this->templates );
		 ...
		 * and $base as static variables in Sanohimi_Wrapping class.
		 *
		 * @since 1.0.0
 ...
 */
function sanohimi_wrap_base_cpts( $templates ) {
