...
if ( ! class_exists( 'Sanohimi_Widget_Area' ) ) {

	class Sanohimi_Widget_Area {
		...
		function __construct() {
			...
			add_action( 'sanohimi_render_widget_area', array( $this, 'render' ) );
		}
		...
		public function render( $area_id ) {
			...
			$area_id        = apply_filters( 'sanohimi_rendering_current_widget_area', $area_id );
			...
			$classes = apply_filters( 'sanohimi_widget_area_classes', $classes, $area_id );
	...
	function sanohimi_widget_area() {
		return Sanohimi_Widget_Area::get_instance();
	}

	sanohimi_widget_area();
}
